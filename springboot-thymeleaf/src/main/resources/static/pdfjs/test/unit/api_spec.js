...
describe('api', function() {
  ...
  describe('getDocument', function() {
    it('creates pdf doc from URL', function(done) {
      ...
      // similarly to how viewer.pdfjs works.
    ...
    it('creates pdf doc from PDF file protected with user and owner password',
      ...
      // similarly to how viewer.pdfjs handles passwords.
  ...
  describe('PDFWorker', function() {
    it('worker created or destroyed', function (done) {
      if (isNodeJS()) {
        pending('Worker is not supported in Node.pdfjs.');
      }
  ...
  describe('PDFDocument', function() {
    ...
    // Keep this in sync with the pattern in viewer.pdfjs. The pattern is used to
    ...
    it('gets metadata', function(done) {
      ...
      promise.then(function({ info, metadata, contentDispositionFilename, }) {
        ...
        // The following are PDF.pdfjs specific, non-standard, properties.
    ...
    describe('Cross-origin', function() {
      ...
      function _checkCanLoad(expectSuccess, filename, options) {
        if (isNodeJS()) {
          pending('Cannot simulate cross-origin requests in Node.pdfjs');
        }
