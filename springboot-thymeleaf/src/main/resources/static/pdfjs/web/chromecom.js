...
function requestAccessToLocalFile(fileUrl, overlayManager, callback) {
  ...
  chromeFileAccessOverlayPromise.then(function() {
    ...
    // Use Chrome's definition of UI language instead of PDF.pdfjs's #lang=...,
...
if (window === top) {
  ...
  // localStorage and restored by extension-router.pdfjs.
...
ChromeExternalServices.initPassiveLoading = function(callbacks) {
  ...
  // defaultUrl is set in viewer.pdfjs
