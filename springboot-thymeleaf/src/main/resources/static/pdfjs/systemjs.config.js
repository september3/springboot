...
(function () {
  ...
  var PluginBabelPath = 'node_modules/systemjs-plugin-babel/plugin-babel.pdfjs';
  var SystemJSPluginBabelPath =
    'node_modules/systemjs-plugin-babel/systemjs-babel-browser.pdfjs';
  var PluginBabelCachePath = 'external/systemjs/plugin-babel-cached.pdfjs';
  ...
  SystemJS.config({
    ...
    paths: {
      ...
      'core-js': new URL('node_modules/core-pdfjs', baseLocation).href,
    },
    meta: {
      '*': {
        scriptLoad: false,
