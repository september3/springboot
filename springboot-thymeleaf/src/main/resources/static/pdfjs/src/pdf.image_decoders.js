...
// To ensure that the standalone PDF.pdfjs image decoders have the same
// browser/environment compatibility as the regular PDF.pdfjs library,
...
// of the complete PDF.pdfjs library, e.g. they are completely synchronous,
// some of the larger polyfills are thus unnecessary.
//
// In an attempt to reduce the size of the standalone PDF.pdfjs image decoders,
