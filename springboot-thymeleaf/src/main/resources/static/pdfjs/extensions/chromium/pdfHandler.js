...
*/
/* import-globals-from preserve-referer.pdfjs */
...
chrome.webRequest.onHeadersReceived.addListener(
  function(details) {
    ...
    // Implemented in preserve-referer.pdfjs
    saveReferer(details);
...
// Remove keys from storage that were once part of the deleted feature-detect.pdfjs
